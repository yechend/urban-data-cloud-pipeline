"""
File: aussocialquery.py
Author: Yechen Deng
Date: 21/05/2024
Description: This program send a query to ES to harvest data from aus.social 2024-05-20 to 2024-05-26 for analysis.
"""
import json
import logging
...
def main():
    ...
    try:
        response = client.search(index="aussocial", body=query)
