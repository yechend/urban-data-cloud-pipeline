"""
File: test_mharvester.py
Author: Yechen Deng
Date: 21/05/2024
Description: This unittest tests the seven functionalities in mharvester.py
"""
import unittest
from mharvester import remove_html_tags, get_tokens, parse_html,extract_post_info, update_state, read_state
from datetime import datetime
from unittest.mock import patch, MagicMock

class TestMHarvester(unittest.TestCase):

    # Test remove the html tags in the content
    ...
    # Test the count calculated in the function in mharvester
    @patch('mharvester.requests.get')
    def test_get_timelines(self, mocked_get):
        ...
        from mharvester import get_timelines  # ensure imported properly to avoid patch issues
...
@patch('mharvester.Elasticsearch')
